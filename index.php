            ...
            <div class="card">
                <div class="card">
                    <div class="card-header">
                        <p class="fw-bold">AlStore Masuk</p>
                    </div>
                    <div class="card-body fw-bold">
                        <form name="login" method="post" action="login.php" onsubmit="return validation()">
                            <div class="mb-3">
                                <label for="username" class="form-label">Username</label>
                                <input type="text" class="form-control" id="username" placeholder="Masukkan username disini" name="username" required>
                            </div>
                            <div class="mb-3">
                                <label for="pass" class="form-label">Password</label>
                                <input type="password" class="form-control" id="pass" placeholder="Masukkan password disini" name="pass" required>
                            </div>
                            <button type="submit" class="btn btn-brand" value="SIMPAN">Masuk</button>
                            <p>Tidak punya akun? <a href="regist.php">Daftar</a></p>
                        </form>
                    </div>
                </div>
            </div>
